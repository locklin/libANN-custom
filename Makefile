...
default:
	...
	@echo "  make linux-shared            for Linux and g++"
	@echo "  make macosx-g++           for Mac OS X and g++"
	@echo "  make macosx-dynamic       for Mac OS X g++ shared libs"
...
#-----------------------------------------------------------------------------
linux-shared alpha-g++ macosx-g++ macosx-dynamic macosx-test linux-g++ sgi sunos4 sunos4-g++ sunos5 sunos5-g++ sunos5-g++-sl authors-debug authors-perf:
	cd src ; $(MAKE) $@
#	cd test ; $(MAKE) $@
	cd sample ; $(MAKE) $@
	cd ann2fig ; $(MAKE) $@
