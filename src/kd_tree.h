...
public:
	...
	virtual void ann_Leaf_search(ANNdist) = 0;     // dumps the contents of a leaf which covers a data point
...
public:
	...
	virtual void ann_Leaf_search(ANNdist);     // dumps the contents of a leaf which covers a data point
};
